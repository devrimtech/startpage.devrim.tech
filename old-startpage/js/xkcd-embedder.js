...
XKCD.prototype.goTo = function (id, noHistory) {
	var self = this;
	if (!noHistory) {
		if (self.data.num && parseInt(self.data.num) === parseInt(id)) {} else {
...
//-----------------------------------------------------------------------
var xkcd_embedder = new XKCD_Embedder('http://xkcd-embedder.fahmidur.us:80');